...
public class Point {
    ...
    public boolean equals(Object o) {
        ...
        if (!mbrId.equals(point.mbrId)) return false;
        if (!pointKind.equals(point.pointKind)) return false;
        if (!pointAmt.equals(point.pointAmt)) return false;
        if (!regDayTime.equals(point.regDayTime)) return false;
        if (!register.equals(point.register)) return false;
        if (!updtDayTime.equals(point.updtDayTime)) return false;
